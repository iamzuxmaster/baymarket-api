...
class Product(models.Model): 
    ...
    birth_day = models.IntegerField(validators=[
        MaxValueValidator(int(datetime.utcnow().strftime('%Y'))-18), 
...
class Room(models.Model):
    sender = models.ForeignKey(Account, on_delete=models.CASCADE, related_name="baywork_room_sender")
    reader = models.ForeignKey(Account, on_delete=models.CASCADE, related_name="baywork_room_reader")
    product = models.ForeignKey(Product, on_delete=models.CASCADE)
...
class Message(models.Model): 
    ...
    sender = models.ForeignKey(Account, on_delete=models.CASCADE, related_name="baywork_message_sender")
